use crate::{Daoforge, DaoforgeArgs, DaoforgeClient, DaoforgeTrait, events, types, validate_contract};
use soroban_sdk::{Address, Bytes, BytesN, Env, String, contractimpl, panic_with_error, vec};

#[contractimpl]
impl DaoforgeTrait for Daoforge {
    /// Initialize the Daoforge contract with admin configuration.
    ///
    /// # Arguments
