...
use crate::{MigrationTrait, Daoforge, DaoforgeArgs, DaoforgeClient, DaoforgeTrait, types};

pub const MAX_PROJECTS_PER_PAGE: u32 = 10;

#[contractimpl]
impl MigrationTrait for Daoforge {
    ...
    fn add_projects_to_pagination(env: Env, admin: Address, names: Vec<String>) {
        ...
        crate::contract_daoforge::auth_admin(&env, &admin);
