export const featuredProjectsConfigData = [
  {
    projectName: "daoforge",
    projectFullName: "Daoforge - Git on Stellar",
    projectType: "SOFTWARE",
    logoImageLink:
      "https://github.com/Consulting-Manao/daoforge/blob/main/website/static/img/logo.svg",
    description: "Decentralized project governance on Stellar",
    organizationName: "Consulting Manao GmbH",
    officials: {
      websiteLink: "https://daoforge.dev",
      githubLink: "https://github.com/Consulting-Manao/daoforge",
    },
    socialLinks: {},
    authorHandles: ["tupui"],
