...
import { type Badge, type Vote, type VoteChoice } from "../../packages/daoforge";
...
/**
 * Get configured contract client instance (using proven working Daoforge instance)
 */
function getClient() {
  ...
  // Use the proven working Daoforge client instance
