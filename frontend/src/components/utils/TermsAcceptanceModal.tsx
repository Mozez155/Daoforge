              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-card">
                <p className="text-secondary leading-relaxed">
                  {(s.introduction as string) ||
                    "Daoforge is a decentralized governance platform operated by Consulting Manao GmbH, located in Austria. By using our dApp, you agree to be bound by these Terms of Service."}
                </p>
              </div>
              {sections.keyPoints && (
                <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-card">
