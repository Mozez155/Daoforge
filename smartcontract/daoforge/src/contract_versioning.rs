...
use crate::{
    Daoforge, DaoforgeArgs, DaoforgeClient, DaoforgeTrait, VersioningTrait, domain_contract, errors, events,
    types,
};
...
#[contractimpl]
impl VersioningTrait for Daoforge {
    ...
    /// * `ipfs` - CID of the daoforge.toml file with associated metadata
    ///
    /// # Returns
    ...
    /// * `ipfs` - New CID of the daoforge.toml file with metadata
    ///
    /// # Panics
